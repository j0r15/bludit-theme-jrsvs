...
<a class="navbar-brand" href="<?php echo $site->url(); ?>">
	<img class="d-inline-block align-top" src="<?php echo Theme::src('img/logo.png'); ?>" alt="logo">
...
<div class="container">
    ...
    <?php	foreach ($items as $category):
			...
			<li class="nav-item <?php echo (($url->slug()==$category->permalink())?'active':'') ?>">
				<a class="nav-link" href="<?php echo $category->permalink(); ?>"><?php echo $category->name(); ?></a>
			</li>
		<?php endif; endforeach; ?>

		<li class="nav-item">
			<!-- <a class="nav-link" href="https://jrsvs.nl/category/work">Work</a> -->
		</li>

		<li class="nav-item">
			<!-- <a class="nav-link" href="https://jrsvs.nl/tag/work-in-progress">Work in progress</a> -->
		</li>
			...
			<li class="nav-item">
				<!-- <a class="nav-link" href="https://jrsvs.nl/research2/"><i class="fa fa-instagram" aria-hidden="true" width="32px"></i> Research</a> -->
			</li>


			<li class="nav-item">
				<a class="nav-link" target="_blank" href="https://instagram.com/yosoysate"><i class="fa fa-instagram" aria-hidden="true" width="32px"></i> Instagram</a>
			</li>

			<li class="nav-item">
				<a class="nav-link" target="_blank" href="https://github.com/j0r15"><i class="fa fa-github" aria-hidden="true" width="32px"></i> Github</a>
			</li>
